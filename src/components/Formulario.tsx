				...
				<div className="flex flex-col py-6 text-white lg:py-8 md:flex-row md:justify-between max-w-7xl mx-auto  ">
					...
					<form onSubmit={handleSubmit}>
						...
						<div className="flex flex-col gap-2 lg:flex-row mt-7 md:mt-0 md:grid lg:flex ">
							...
							<button
								type="submit"
								className="px-4 font-bold uppercase bg-secondary h-14 text-primary hover:bg-secondarylight transform active:scale-75 transition-transform min-w-fit rounded-lg"
							>
								¡Si, Quiero entrar!
							</button>
						</div>
