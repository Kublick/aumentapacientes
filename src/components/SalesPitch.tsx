	...
	return (
		<>
					...
					<div className="grid mt-10 font-normal md:mt-0 text-lightgray">
						<div>
							<p>
								...
								alumnos profesionales del entregamiento incrementa tu consulta,
								el pertenecer a la comunidad es algo invaluable por que dentro
								de ella podrás ir compartiendo los avances que vayas logrando
								con tus compañeros, y empiezas a sentir el empuje de ser parte
								de una tribu que creme no te va a dejar sola.
							</p>
						...
						<div className="mt-7 m:mt-0">
							...
							<p className="font-bold text-primary">Valorado en $47 dólares</p>
						</div>
						<div className="mt-7 m:mt-0">
							<p>
								<span className="font-bold text-primary">
								...
								cada lección te lleva a la acción con ejercicios detallados, de
								esta manera a medida que avanzas en el programa, también avanzas
								en tu negocio.
							</p>
						</div>
			...
			<p className="mt-16 text-lg text-lightgray">
				Sin duda es muchísimo valor el que tendrás con el entrenamiento completo{' '}
				...
				saldría en eso... Pero hoy tengo una invitación, es una oferta especial
				para ti, hoy tu puedes reservar tu inscripción al entrenamiento de la
				siguiente forma hay 3 modalidades de pago; La primera opción es el{' '}
				<span className="font-bold text-primary">PLAN FLEXIBLE </span> este plan
				te permite diferir tu inscripción al entrenamiento en una primera cuota
				de <span className="font-bold text-primary">$178 dólares </span> y luego
				solo 2 cuotas mas, de la misma cantidad. La segunda opción es el{' '}
				<span className="font-bold text-primary">PLAN PRACTICO</span> este plan
				como su nombre lo dice es practico pagas la mitad ahora y la otra mitad
				hasta el otro mes, hasta abril, con este{' '}
				<span className="font-bold text-primary">PLAN PRACTICO</span> solo hace
				2 pagos de <span className="font-bold text-primary">$261 dólares</span>.
				La tercera opción es el{' '}
				<span className="font-bold text-primary bg-secondary p-1">
					PLAN UNICO
				</span>{' '}
				y es la mejor opción por que te ahorras{' '}
				<span className="font-bold text-primary">$38 dólares</span> haciendo una
				inversión de 1 solo pago por{' '}
			...
			<h1 className="mt-16 mb-8 text-xl font-bold text-primary">
				¿Listo para crear la vida que sueñas? Elige el plan que mejor se adapte
				a tí
			</h1>
			<SalesCards salesDate={saleEventDate} />
			<div className="my-16">
