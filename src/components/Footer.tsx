...
export const Footer = () => {
	return (
		<div className=" bg-primary">
			<div className="pt-16 px-9  md:pt-11 max-w-7xl mx-auto ">
          ...
          >
            {logoYouTube}
				...
				<p className="mt-12 text-xs leading-5 text-white">
					...
					compartiendo lo que hemos aprendido de nuestras experiencias y la lo
					desee, utilizando el enlace para des suscribirse que aparecerá en los
					correos electrónicos.
				</p>
				<div className="flex flex-col gap-6 mt-16 md:flex-row lg:justify-between md:gap-0">
					...
					<p className="px-2 pt-5 pb-12 text-sm font-extrabold text-center text-primary bg-secondary">
