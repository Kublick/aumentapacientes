	...
	return (
		<div className="border-2 md:w-[235px] lg:w-[348px] border-primary">
			...
			<div className="flex flex-col items-center p-4">
				...
				<button
					className={`${buttonStyle} text-base font-semibold border-primary border-2 w-full px-2 py-4 mt-4 text-primary hover:bg-yellow-500 hover:opacity-90 rounded-lg hover:bg-transparent`}
